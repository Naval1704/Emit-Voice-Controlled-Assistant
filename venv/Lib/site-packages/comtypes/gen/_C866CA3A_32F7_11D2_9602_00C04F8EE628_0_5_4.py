...
__all__ = [
    ...
    'DISPID_SMSALineId', 'DISPID_SPAs_NewEnum', 'DISPID_SPPs_NewEnum',
    'eLEXTYPE_RESERVED10', 'DISPID_SFSOpen',
    'SpeechCategoryRecognizers', 'SPEI_SOUND_END', 'SRTStandard',
    'DISPID_SBSWrite', 'eLEXTYPE_PRIVATE12', 'SPXRO_SML',
    'SSSPTRelativeToCurrentPosition', 'SVESentenceBoundary',
    'SVPAlert', 'SPXMLRESULTOPTIONS', 'SAFT48kHz8BitMono',
    'DISPID_SGRsCommitAndSave', 'SPEI_WORD_BOUNDARY',
    'SPEI_PHRASE_START', 'DISPID_SOTsCount', 'ISpeechXMLRecoResult',
    'DISPID_SVDisplayUI', 'SAFTADPCM_22kHzMono', 'SPSERIALIZEDPHRASE',
    'DISPID_SOTId', 'DISPID_SVESentenceBoundary',
    'DISPID_SRCAudioInInterferenceStatus', 'SPEI_HYPOTHESIS',
    'SPWT_PRONUNCIATION', 'DISPID_SMSAMMHandle', 'SPBO_TIME_UNITS',
    'ISpeechGrammarRuleStateTransition', 'ISpeechPhraseElements',
    'ISpRecoCategory', 'DISPID_SGRSTWeight', 'SREFalseRecognition',
    'SVSFNLPMask', 'SRTSMLTimeout', 'DISPID_SVEEnginePrivate',
    'DISPID_SREmulateRecognition', 'DISPID_SVSpeakStream',
    'SDTDisplayText', 'SVSFlagsAsync', 'SVP_16',
    'DISPID_SPEAudioSizeTime', 'ISpeechPhraseProperty',
    'DISPID_SOTRemoveStorageFileName', 'SAFTExtendedAudioFormat',
    'SAFT24kHz16BitMono', 'SPWORDPRONUNCIATION',
    'SGLexicalNoSpecialChars', 'DISPID_SVEventInterests',
    'DISPID_SpeechLexiconWord',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SITooSlow',
    'DISPID_SRRSpeakAudio', 'DISPID_SRGetFormat',
    'DISPID_SRGCmdSetRuleIdState', 'DISPIDSPTSI_ActiveOffset',
    'SAFT12kHz16BitStereo', 'SpeechGrammarRuleStateTransitionType',
    'SAFTADPCM_8kHzMono', 'SpCompressedLexicon',
    'DISPID_SpeechGrammarRules', 'SGRSTTEpsilon', 'DISPID_SLGetWords',
    'DISPID_SLPLangId', 'SpeechWordType', 'SAFT44kHz8BitMono',
    'SPFM_NUM_MODES', 'SpTextSelectionInformation', 'STSF_FlagCreate',
    'ISpeechPhraseInfoBuilder', 'SpeechRuleAttributes', 'SLOStatic',
    'SAFT8kHz16BitStereo', 'DISPID_SpeechLexiconPronunciation',
    'SPXRO_Alternates_SML', 'DISPID_SGRSRule', 'SAFT22kHz8BitMono',
    'SpeechTokenIdUserLexicon', 'DISPID_SVGetAudioOutputs',
    'SSFMCreate', 'SDTLexicalForm', 'SVP_11', 'DISPID_SRCEHypothesis',
    'SPPS_Noncontent', 'ISpGrammarBuilder',
    ...
    'SPSERIALIZEDRESULT', 'ISpeechLexiconWords', 'SPRS_INACTIVE',
    'DISPID_SVEWord', 'SECFEmulateResult', 'ISpeechPhraseInfo',
    'SpMMAudioIn', 'DISPID_SGRSAddWordTransition',
    'DISPID_SLAddPronunciation', 'SAFTGSM610_22kHzMono',
    'ISpeechTextSelectionInformation', 'DISPID_SVEVoiceChange',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SGRInitialState',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SABIEventBias',
    'eLEXTYPE_RESERVED7', 'SPVISEMES', 'SPVOICESTATUS',
    'SPEI_END_INPUT_STREAM', 'eLEXTYPE_PRIVATE8',
    'SpeechInterference', 'SPRULESTATE', 'SPEI_RESERVED5',
    'SpeechEmulationCompareFlags', 'SVP_8', 'DISPID_SVRate',
    'SAFT44kHz16BitMono', 'SPEI_MIN_TTS', 'SpeechEngineProperties',
    'SPSHT_Unknown', 'SVP_3', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPAStartElementInResult', 'DISPID_SPPEngineConfidence',
    'SRAExport', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPCT_SUB_DICTATION', 'SpeechLoadOption', 'Speech_StreamPos_Asap',
    'SPAUDIOBUFFERINFO', 'SRESoundStart', 'SPPHRASEREPLACEMENT',
    'SpFileStream', 'DISPID_SVVolume', 'DISPID_SRCSetAdaptationData',
    'SpMMAudioEnum', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SOTCGetDataKey', 'SAFTText', '_ISpeechRecoContextEvents',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPVPRIORITY',
    'SGDSActiveWithAutoPause', 'DISPID_SOTGetDescription',
    'DISPID_SLPPhoneIds', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRRGetXMLResult', 'SpeechDisplayAttributes',
    'SREStreamStart', 'SpeechPropertyAdaptationOn',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCEPhraseStart',
    'SAFT22kHz8BitStereo', 'SAFT22kHz16BitStereo', 'SPRST_NUM_STATES',
    'SLTUser', 'DISPID_SPELexicalForm',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPSSuppressWord',
    'eLEXTYPE_PRIVATE3', 'DISPID_SLAddPronunciationByPhoneIds',
    'SDTPronunciation', 'SPRECORESULTTIMES', 'DISPID_SpeechVoice',
    'DISPID_SpeechPhraseAlternate', 'SpObjectTokenCategory',
    'ISpeechCustomStream', 'DISPID_SGRsDynamic',
    'SAFTADPCM_22kHzStereo', 'SASStop', 'eLEXTYPE_APP',
    'DISPID_SRGIsPronounceable', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPERequiredConfidence', 'SAFT48kHz16BitMono',
    'DISPID_SpeechPhraseReplacements', 'ISpeechRecoResult2',
    'DISPID_SRCEInterference', 'SFTSREngine', 'DISPID_SWFEFormatTag',
    'SVSFPersistXML', 'DISPID_SpeechGrammarRuleState', 'SPCS_ENABLED',
    'SVF_None', 'SAFT32kHz16BitStereo', 'SPPS_RESERVED4',
    'SpeechRegistryUserRoot', 'SPSHT_NotOverriden',
    'DISPID_SDKCreateKey', 'ISpShortcut', 'SP_VISEME_21',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRCEAudioLevel',
    'SAFTADPCM_8kHzStereo', 'ISequentialStream', 'SPWF_INPUT',
    'SVEPrivate', 'SpeechPropertyComplexResponseSpeed',
    'eLEXTYPE_PRIVATE5', 'DISPID_SpeechBaseStream',
    'DISPID_SPIProperties', 'DISPID_SOTs_NewEnum',
    'SpStreamFormatConverter', 'eLEXTYPE_RESERVED9',
    'DISPID_SPRulesCount', 'SPWORDPRONUNCIATIONLIST',
    'SpeechRecognitionType', 'SP_VISEME_4', 'SPWF_SRENGINE',
    'DISPID_SLWsCount', 'SPGS_DISABLED', 'DISPID_SRCEEndStream',
    'SAFTCCITT_uLaw_22kHzMono', 'SDA_Consume_Leading_Spaces',
    'DISPID_SRRSetTextFeedback', 'eLEXTYPE_PRIVATE10',
    'eWORDTYPE_DELETED', 'SPDKL_CurrentUser',
    'DISPID_SRRGetXMLErrorInfo', 'ISpeechPhraseRules',
    'SRAInterpreter', 'SpeechDiscardType', 'SP_VISEME_2',
    'DISPID_SPAsCount', 'DISPID_SGRSTsItem', 'SP_VISEME_6',
    'DISPID_SPEsCount', 'DISPID_SVEAudioLevel',
    'SpeechVoiceCategoryTTSRate', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRRTimes', 'ISpNotifyTranslator',
    'DISPID_SRCRetainedAudio', 'SWPUnknownWordPronounceable',
    'SAFT11kHz16BitMono', 'SSFMOpenReadWrite', 'SPBINARYGRAMMAR',
    'SSFMCreateForWrite', 'SPFILEMODE', 'DISPID_SDKEnumValues',
    'DISPID_SMSSetData', 'SECFNoSpecialChars',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpEventSink',
    'DISPID_SWFEBlockAlign', 'SpNullPhoneConverter', 'SPSNoun',
    'SPRST_INACTIVE_WITH_PURGE', 'SPEI_SR_PRIVATE',
    'DISPID_SPCLangId', 'SpeechTokenValueCLSID', 'SRADynamic',
    'DISPID_SPEsItem', 'DISPID_SCSBaseStream', 'DISPID_SABufferInfo',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRCESoundEnd',
    'SPAO_RETAIN_AUDIO', 'SpeechGrammarState', 'DISPID_SPAPhraseInfo',
    'DISPID_SRRTStreamTime', 'ISpeechGrammarRule',
    ...
    'DISPID_SPIRule', 'SAFTADPCM_11kHzMono', 'SpeechVoiceSpeakFlags',
    'DISPID_SOTRemove', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SOTCEnumerateTokens',
    'SAFT24kHz16BitStereo', 'eLEXTYPE_RESERVED4', 'SPPS_Verb',
    'SPCT_SUB_COMMAND', 'DISPID_SPARecoResult',
    'DISPID_SPRuleChildren', 'SP_VISEME_0', 'DISPID_SLWsItem',
    'SpeechStreamFileMode', 'SP_VISEME_12', 'eLEXTYPE_PRIVATE1',
    'SRAONone', 'SPRECOGNIZERSTATUS', 'SAFTCCITT_uLaw_11kHzStereo',
    'SASPause', 'SPDATAKEYLOCATION', 'SpeechRunState',
    ...
    'SpeechAudioFormatGUIDText', 'SPSEMANTICFORMAT', 'SPEVENT',
    'SPEI_RESERVED6', 'ISpeechGrammarRuleStateTransitions',
    'eLEXTYPE_USER', 'SAFT11kHz8BitMono', 'SPEI_FALSE_RECOGNITION',
    'SpWaveFormatEx', 'SpMemoryStream', 'SPINTERFERENCE',
    'DISPID_SpeechPhraseElement', 'DISPID_SVResume', 'SVP_13',
    'DISPID_SVEStreamStart', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRGDictationLoad', 'SP_VISEME_18',
    ...
    'SPAR_High', 'SPAS_STOP', 'DISPID_SVEViseme', 'ISpEventSource',
    'SpeechGrammarTagWildcard', 'SpeechAudioFormatType',
    'SPFM_OPEN_READWRITE', 'SVSFParseSapi',
    'DISPID_SVSLastStreamNumberQueued', 'ISpeechLexicon',
    'DISPID_SRGCommit', 'DISPID_SGRSTType',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRGCmdLoadFromObject',
    'SPAUDIOSTATE', 'SAFT11kHz16BitStereo', 'SPADAPTATIONRELEVANCE',
    'SVP_7', 'eLEXTYPE_PRIVATE15', 'SREAllEvents',
    'DISPID_SRGetPropertyNumber', 'ISpMMSysAudio', 'SPEI_RESERVED1',
    'DISPID_SGRSTs_NewEnum', 'SVP_6', 'SpeechCategoryPhoneConverters',
    'SAFT32kHz8BitStereo', 'SRAImport', 'SPGRAMMARSTATE',
    'DISPID_SDKDeleteValue', 'DISPID_SRCVoicePurgeEvent',
    'SpeechVoicePriority', 'SASClosed', 'DISPID_SPIGrammarId',
    'ISpPhrase', 'eLEXTYPE_PRIVATE14', 'SPSFunction',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SDKSetStringValue',
    'SREAudioLevel', 'SVEPhoneme', 'DISPID_SpeechAudioStatus',
    'DISPID_SVGetVoices', 'SAFTCCITT_ALaw_8kHzMono', 'STCAll',
    'SPSTREAMFORMATTYPE', 'IInternetSecurityManager',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SOTSetId',
    'DISPID_SOTCDefault', 'SVEAudioLevel', 'DISPID_SASetState',
    'SRTExtendableParse', 'DISPID_SPEAudioTimeOffset',
    'SpeechCategoryAudioOut', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SPEActualConfidence', 'SBONone', 'SPFM_CREATE_ALWAYS',
    'IEnumSpObjectTokens', 'DISPID_SPRs_NewEnum', 'SGRSTTWildcard',
    'SVEStartInputStream', 'SECLowConfidence', 'SREPrivate',
    'SpPhraseInfoBuilder', 'DISPID_SRGDictationUnload',
    'SWPKnownWordPronounceable', 'DISPID_SRProfile',
    'SpeechTokenKeyAttributes', 'SpeechWordPronounceable',
    'SPSHT_OTHER', 'SpPhoneticAlphabetConverter',
    'SpInProcRecoContext', 'ISpeechAudioStatus',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPVPRI_NORMAL',
    'DISPID_SRCCmdMaxAlternates', 'SpeechAudioState',
    'SPEI_RESERVED3', 'SPPS_RESERVED3', 'DISPID_SABIBufferSize',
    'SPGS_EXCLUSIVE', 'ISpObjectWithToken', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRRAudioFormat', 'SPEI_SR_RETAINEDAUDIO',
    'SpeechUserTraining', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRCEBookmark', 'ISpNotifySink', 'SVPNormal',
    'DISPID_SLGetPronunciations', 'DISPID_SGRSTPropertyId',
    'SpSharedRecoContext', 'SAFT44kHz8BitStereo', 'DISPID_SGRsAdd',
    'SPGS_ENABLED', 'DISPID_SGRAddState', 'SPEI_RESERVED2',
    'SVEWordBoundary', 'ISpProperties', 'SP_VISEME_9',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPRulesItem',
    'DISPID_SRGId', 'ISpObjectToken', 'DISPID_SpeechCustomStream',
    'SPDKL_DefaultLocation', 'SPSHORTCUTTYPE',
    'SpeechTokenShellFolder', 'SP_VISEME_14',
    'DISPID_SPEEngineConfidence', 'DISPID_SRDisplayUI', 'SITooFast',
    'DISPID_SpeechRecognizerStatus', 'SPPS_RESERVED1', 'ISpLexicon',
    'eLEXTYPE_PRIVATE4', 'SGDSActive', 'DISPID_SLRemovePronunciation',
    'ISpResourceManager', 'SpVoice', 'SPCT_COMMAND',
    'SAFTGSM610_44kHzMono', 'SDKLDefaultLocation',
    ...
    'SPSUnknown', 'IStream', 'SpAudioFormat', 'SAFT22kHz16BitMono',
    'SPRECOSTATE', 'SpResourceManager', 'DISPID_SLWPronunciations',
    'DISPID_SpeechPhraseReplacement', 'SPPHRASE',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRSetPropertyString',
    'DISPID_SBSSeek', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechVoiceEvent', 'IEnumString', 'SDKLLocalMachine',
    'DISPID_SpeechLexicon', 'SPEI_SENTENCE_BOUNDARY',
    'SpeechRuleState', 'DISPID_SPRDisplayAttributes',
    'DISPID_SVSLastBookmark', 'SPPS_Noun', 'ISpPhraseAlt',
    'ISpeechRecoResultDispatch', 'SPPS_NotOverriden',
    'DISPID_SRSAudioStatus', 'SPBOOKMARKOPTIONS',
    'ISpeechPhoneConverter', 'ISpRecoGrammar2', 'SPWT_LEXICAL',
    'DISPID_SPRuleParent', 'DISPID_SPERetainedSizeBytes',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SVPriority',
    'SPCT_SLEEP', 'SRADefaultToActive', 'SSFMOpenForRead',
    'ISpeechRecognizerStatus', 'DISPID_SLGenerationId',
    'SPPS_RESERVED2', 'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SLWType',
    'DISPID_SRCEventInterests', 'DISPID_SVSpeak',
    'DISPID_SPILanguageId', 'DISPID_SRState', 'SpeechLexiconType',
    'SpeechPropertyNormalConfidenceThreshold', 'SpSharedRecognizer',
    'DISPID_SpeechRecoResult', 'DISPID_SASFreeBufferSpace',
    'Speech_Max_Word_Length', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRCRequestedUIType', 'ISpeechRecoResultTimes',
    'SAFTCCITT_ALaw_11kHzMono', 'SPTEXTSELECTIONINFO',
    'DISPID_SDKEnumKeys', 'DISPID_SWFESamplesPerSec',
    'SPINTERFERENCE_NOISE', 'DISPID_SPPFirstElement', 'SpLexicon',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpeechPhraseElement', 'ISpAudio',
    'SWPUnknownWordUnpronounceable', 'SGLexical', 'SREStreamEnd',
    'SGSDisabled', 'DISPID_SMSGetData', 'SP_VISEME_20',
    'SDTAlternates', 'SPAR_Low', 'SVP_0', 'DISPID_SpeechDataKey',
    'SpeechPropertyHighConfidenceThreshold', 'SPPS_SuppressWord',
    'DISPID_SRCERecognition', 'SFTInput', 'DISPID_SGRSTransitions',
    'SpeechDictationTopicSpelling', 'SPGRAMMARWORDTYPE',
    'Speech_Max_Pron_Length', 'DISPID_SRCResume', 'SPEI_MAX_SR',
    'DISPID_SVAudioOutput', 'SASRun', 'SDA_One_Trailing_Space',
    'DISPID_SRCESoundStart', 'DISPID_SASState', 'DISPID_SGRSTText',
    'DISPID_SWFEAvgBytesPerSec', 'SDTProperty', 'SPSMF_UPS',
    'SPWT_DISPLAY', 'SPEI_ADAPTATION', 'DISPID_SRCRecognizer',
    'STSF_CommonAppData', 'DISPID_SVAlertBoundary', 'SP_VISEME_11',
    'DISPID_SpeechAudioFormat', 'SGRSTTWord', 'eLEXTYPE_RESERVED8',
    'SpeechStreamSeekPositionType', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPEI_REQUEST_UI', 'SECFIgnoreCase', 'SVP_20',
    'SPSMF_SAPI_PROPERTIES', 'SRSActiveAlways', 'SECNormalConfidence',
    'DISPID_SMSADeviceId', 'DISPID_SRGReset',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SAFType',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRCPause', 'eLEXTYPE_PRIVATE16',
    'eLEXTYPE_VENDORLEXICON', 'ISpeechRecognizer',
    'DISPID_SpeechGrammarRule', 'SDTAudio', 'SVP_10',
    ...
    'SAFT16kHz8BitStereo', 'STCInprocServer', 'SVSFIsFilename',
    'SPRULE', 'ISpeechMMSysAudio', 'DISPID_SpeechAudioBufferInfo',
    'ISpeechPhraseProperties', 'eLEXTYPE_PRIVATE20',
    'SpeechMicTraining', 'SVSFUnusedFlags', 'ISpRecoResult',
    'SPFM_OPEN_READONLY', 'DISPID_SOTCategory', 'LONG_PTR',
    'DISPID_SGRsItem', 'SP_VISEME_3', 'SPEI_UNDEFINED',
    'SPAR_Unknown', 'DISPID_SRRAudio', 'ISpeechVoice',
    'STSF_LocalAppData', 'DISPID_SRCCreateGrammar',
    'eLEXTYPE_PRIVATE18', 'DISPID_SAEventHandle',
    'ISpeechWaveFormatEx', 'DISPID_SAFSetWaveFormatEx', 'SPPS_LMA',
    'ISpeechObjectTokens', 'SVP_5', 'SpeechAudioProperties',
    'DISPID_SFSClose', 'DISPID_SDKGetlongValue',
    'DISPID_SOTGetAttribute', 'SECFDefault', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPCIdToPhone', 'SPSHORTCUTPAIRLIST', 'SPPS_Interjection',
    'DISPID_SPIReplacements', 'ISpStreamFormat', 'SRCS_Enabled',
    'SPEI_SOUND_START', 'SP_VISEME_8', 'ISpeechRecoGrammar',
    'SRSEIsSpeaking', 'DISPID_SLWLangId', 'SECFIgnoreKanaType',
    'DISPID_SRRSaveToMemory', 'SpeechTokenKeyUI', 'WAVEFORMATEX',
    'SAFT48kHz16BitStereo', 'SITooQuiet', 'SpeechGrammarTagDictation',
    'SPCS_DISABLED', 'ISpVoice', 'DISPID_SDKSetLongValue',
    'DISPID_SLWs_NewEnum', 'ISpRecoGrammar', 'DISPID_SPRsItem',
    'DISPID_SPPId', 'SINone', 'SPLOADOPTIONS', 'SAFTADPCM_44kHzMono',
    'DISPID_SpeechPhraseRule', 'STCInprocHandler', 'STSF_AppData',
    'DISPID_SAFGuid', 'SPAO_NONE', 'DISPID_SRCVoice', 'SPPS_Function',
    'SVEViseme', 'SPWORDLIST', 'SpeechAudioVolume', 'DISPID_SBSRead',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechRecoResult2',
    'SGSEnabled', 'DISPID_SRGetRecognizers', 'UINT_PTR',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPINTERFERENCE_TOOLOUD', 'SGDSActiveUserDelimited',
    'SPWAVEFORMATTYPE', 'DISPID_SGRSAddSpecialTransition',
    'SP_VISEME_17', 'SpObjectToken', 'SPSHORTCUTPAIR',
    'DISPID_SRGSetTextSelection', 'DISPID_SRSetPropertyNumber',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SDKGetStringValue', 'SPWORD',
    'SRERecoOtherContext', 'SAFTNonStandardFormat',
    'SVSFNLPSpeakPunc', 'DISPID_SBSFormat',
    'DISPID_SVAudioOutputStream', 'SpMMAudioOut',
    'DISPID_SPRuleConfidence', 'DISPID_SVVoice',
    'SPSEMANTICERRORINFO', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SPACommit', 'SpeechCategoryAppLexicons', 'SVPOver',
    'DISPID_SPPValue', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPPNumberOfElements',
    'SPBO_NONE', 'SRSEDone', 'SWTDeleted', 'SREInterference',
    'SP_VISEME_15', 'DISPID_SGRClear', 'ISpXMLRecoResult',
    'SPBO_AHEAD', 'SpeechPartOfSpeech',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRAudioInput',
    'tagSTATSTG', 'DISPID_SVEStreamEnd', 'ISpeechPhraseRule',
    'SPCONTEXTSTATE', 'DISPID_SpeechMemoryStream',
    'SAFT24kHz8BitStereo', 'SREHypothesis',
    'DISPID_SRSNumberOfActiveRules', 'SDKLCurrentConfig',
    'DISPID_SRSCurrentStreamNumber', 'SpStream', 'SPEI_RECOGNITION',
    'SVP_15', 'SPSInterjection', 'SpeechPropertyResponseSpeed',
    'DISPID_SASCurrentSeekPosition',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPCATEGORYTYPE', 'SPSLMA', 'ISpSerializeState', 'SVP_2',
    ...
    'DISPIDSPTSI_SelectionLength', 'ISpRecoContext',
    'SRSInactiveWithPurge', 'SPSHT_EMAIL', 'SDTReplacement',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'Speech_StreamPos_RealTime', 'SRERequestUI', 'SPEVENTSOURCEINFO',
    'DISPID_SRRTTickCount', 'DISPID_SDKDeleteKey',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechGrammarRules',
    'SAFT24kHz8BitMono', 'SPPHRASEPROPERTY', 'DISPID_SPIEngineId',
    'SPLEXICONTYPE', 'ISpRecoContext2', 'SRSInactive',
    'DISPID_SRCCreateResultFromMemory', 'SREStateChange',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPEs_NewEnum',
    'ISpRecognizer3', 'Speech_Default_Weight', 'SPAUDIOOPTIONS',
    'DISPID_SRIsShared', 'SpShortcut', 'SSTTWildcard', 'SRATopLevel',
    'SSSPTRelativeToStart', 'DISPID_SLPsItem',
    'DISPID_SADefaultFormat', 'DISPID_SGRSTRule', 'SPAR_Medium',
    'SRTReSent', 'SGDSInactive', 'eLEXTYPE_PRIVATE13',
    'SpeechPropertyResourceUsage',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SP_VISEME_5',
    'DISPID_SRIsUISupported', 'SVF_Emphasis', 'SVSFDefault',
    'DISPID_SpeechFileStream', 'DISPID_SRCBookmark',
    'SpeechRecognizerState', 'ISpeechMemoryStream',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SpeechObjectTokens',
    'SGSExclusive', 'DISPID_SpeechPhraseRules',
    'tagSPTEXTSELECTIONINFO', 'SAFT11kHz8BitStereo',
    'DISPID_SVEBookmark', '_SPAUDIOSTATE',
    'SpeechPropertyLowConfidenceThreshold', 'SPPROPERTYINFO',
    'DISPID_SOTDisplayUI', 'ISpeechGrammarRuleState', 'SP_VISEME_10',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SP_VISEME_19',
    'ISpeechRecoContext', 'SRTEmulated', 'DISPID_SVSVisemeId',
    'DISPID_SGRSTPropertyName', '_RemotableHandle', 'SVP_12',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SWTAdded',
    'SpeechAddRemoveWord', 'SpeechVisemeFeature',
    'SVSFPurgeBeforeSpeak', 'SVEAllEvents', 'SPBO_PAUSE',
    'DISPID_SpeechPhraseInfo', 'ISpRecognizer2', 'DISPID_SPRText',
    ...
    'SRESoundEnd', 'DISPID_SVGetAudioInputs', 'SAFT32kHz16BitMono',
    'DISPID_SAStatus', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPAS_RUN', 'SPEI_RECO_STATE_CHANGE', 'SpUnCompressedLexicon',
    'SPWORDTYPE', 'DISPID_SVSyncronousSpeakTimeout', 'SDTRule',
    'SVEBookmark', 'SDA_No_Trailing_Space', 'SPINTERFERENCE_NOSIGNAL',
    'eLEXTYPE_PRIVATE11', 'SPEI_TTS_PRIVATE',
    'DISPID_SPISaveToMemory', 'SPVPRI_OVER', 'SVP_19',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SINoSignal',
    'DISPID_SRRAlternates', 'SPAS_PAUSE', 'ISpeechPhraseAlternates',
    'SPPHRASEELEMENT', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SVSInputSentenceLength', 'SAFT8kHz8BitMono', 'SGRSTTRule',
    'DISPID_SRGCmdLoadFromMemory', 'ISpObjectTokenCategory',
    'SpeechVoiceSkipTypeSentence', 'SPEI_SR_BOOKMARK',
    'SGPronounciation', 'SAFT48kHz8BitStereo',
    'SpeechRetainedAudioOptions', 'DISPID_SWFEChannels',
    'DISPID_SRSSupportedLanguages', 'SAFTCCITT_uLaw_11kHzMono',
    '_ISpeechVoiceEvents', 'DISPID_SPEDisplayText',
    'DISPID_SRAudioInputStream', 'DISPID_SRGCmdLoadFromFile',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SPEAudioStreamOffset',
    'SVF_Stressed', 'DISPID_SpeechRecoContext', 'SPCT_DICTATION',
    'DISPID_SDKOpenKey', 'SPAS_CLOSED', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPPName', 'DISPID_SRCERequestUI',
    'DISPID_SGRSTPropertyValue', 'SPPS_Modifier', 'SITooLoud',
    'DISPID_SPAsItem', 'SpeechFormatType', 'DISPID_SAVolume',
    'SPEI_END_SR_STREAM', 'DISPID_SPRsCount',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRCState', 'SP_VISEME_16',
    'DISPID_SRGRules', 'SpeechBookmarkOptions', 'SVSFParseMask',
    'SAFT32kHz8BitMono', 'SPEI_START_SR_STREAM', 'ISpeechFileStream',
    'SGRSTTDictation', 'SAFTNoAssignedFormat', 'SVP_4',
    'SpeechEngineConfidence', 'SPAUDIOSTATUS', 'SRARoot',
    'SPLO_STATIC', 'SPEI_MAX_TTS', 'DISPID_SRStatus',
    'DISPID_SRCreateRecoContext', 'SVSFVoiceMask',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_MIN_SR',
    'SPEI_SR_AUDIO_LEVEL', 'SAFTCCITT_ALaw_44kHzStereo',
    'SREBookmark', 'SpeechCategoryAudioIn', 'SPINTERFERENCE_TOOQUIET',
    'SSTTTextBuffer', 'DISPID_SOTDataKey',
    'DISPID_SpeechObjectTokenCategory', 'SAFTGSM610_8kHzMono',
    'SPEI_TTS_BOOKMARK', 'DISPID_SPPParent', 'DISPID_SRSClsidEngine',
    'SDKLCurrentUser', 'DISPID_SRGState', 'SAFTDefault',
    'SREAdaptation', 'DISPID_SASNonBlockingIO', 'SP_VISEME_1',
    ...
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SGRAddResource', 'SPEVENTENUM',
    'SpeechRecoContextState', 'DISPID_SLPSymbolic',
    'SpeechAudioFormatGUIDWave', 'DISPID_SOTCSetId',
    'DISPID_SpeechXMLRecoResult', 'SAFTADPCM_11kHzStereo',
    'ISpeechPhraseAlternate', 'ISpeechDataKey', 'SPLO_DYNAMIC',
    'SPEI_PHONEME', 'DISPID_SGRsCommit', 'DISPID_SpeechMMSysAudio',
    'SVEVoiceChange', 'DISPID_SOTCreateInstance', 'SpeechAllElements',
    'DISPID_SPEAudioSizeBytes', 'SPRST_INACTIVE',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SOTsItem',
    'SAFT16kHz16BitMono', 'SPRS_ACTIVE', 'DISPID_SPRNumberOfElements',
    'SpeechCategoryRecoProfiles', 'SVP_1',
    'DISPID_SRGDictationSetState', 'ISpeechObjectToken',
    'DISPID_SVWaitUntilDone', 'DISPID_SPPConfidence',
    'eLEXTYPE_RESERVED6', 'DISPID_SWFEExtraData', 'DISPID_SPIGetText',
    'eLEXTYPE_PRIVATE7', 'STCLocalServer',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFT12kHz8BitStereo',
    'SPRST_ACTIVE', 'SAFT12kHz8BitMono', 'ISpDataKey',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechAudioBufferInfo',
    'SAFT16kHz8BitMono', 'SpeechDataKeyLocation', 'SBOPause',
    'DISPID_SRRecognizer', 'SPEI_INTERFERENCE', 'ISpeechAudioFormat',
    'DISPID_SGRId', 'DISPID_SGRs_NewEnum', 'DISPID_SVSRunningState',
    'ISpeechResourceLoader', 'SPDKL_CurrentConfig',
    'DISPID_SABufferNotifySize', 'DISPID_SLWWord',
    'DISPID_SpeechLexiconProns',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRGSetWordSequenceData', 'SpCustomStream', 'SP_VISEME_13',
    'SVP_17', 'DISPID_SWFEBitsPerSample', 'DISPID_SVPause', 'SVP_18',
    'DISPID_SVSkip', 'ISpeechLexiconPronunciations',
    'DISPID_SPPChildren', 'DISPID_SRGRecoContext',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPEPronunciation',
    'SpNotifyTranslator', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    '__MIDL_IWinTypes_0009', 'SLTApp', 'SPSNotOverriden',
    'SAFT12kHz16BitMono', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpeechPhraseReplacements', 'SpeechGrammarWordType',
    'SVSFIsNotXML', 'eWORDTYPE_ADDED', 'DISPID_SRGetPropertyString',
    'ISpStream', 'SPFM_CREATE', 'SREPropertyStringChange',
    'DISPID_SVStatus', 'SVP_9', 'ISpPhoneConverter',
    'SPINTERFERENCE_NONE', 'DISPID_SDKSetBinaryValue', 'ISpeechAudio',
    'SLODynamic', 'SRTAutopause', 'SRERecognition',
    'DISPID_SpeechAudio', 'DISPID_SPRuleId', 'SAFT44kHz16BitStereo',
    'DISPID_SLPType', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPPsCount', 'SVSFParseAutodetect', 'DISPID_SPIStartTime',
    'SpeechVisemeType', 'DISPID_SRRTOffsetFromStart',
    'ISpeechRecoResult', 'SPPS_Unknown', 'DISPID_SGRAttributes',
    'SSSPTRelativeToEnd', 'SPPARTOFSPEECH',
    'ISpPhoneticAlphabetSelection', 'ISpRecognizer',
    'tagSPPROPERTYINFO', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRCEStartStream', 'SVSFIsXML', 'ISpNotifySource',
    'SpPhoneConverter', 'SRAORetainAudio', 'SREPropertyNumChange',
    'SRSActive', 'DISPID_SOTMatchesAttributes', 'SGRSTTTextBuffer',
    'DISPID_SPCPhoneToId', 'STCRemoteServer',
    'IInternetSecurityMgrSite', 'SRCS_Disabled',
    'DISPID_SLPs_NewEnum', 'DISPID_SpeechPhraseElements',
    'DISPID_SLPsCount', 'ISpeechLexiconPronunciation',
    'DISPID_SPPsItem', 'eLEXTYPE_PRIVATE6',
    'DISPID_SpeechPhoneConverter', 'SVP_21', 'SINoise',
    'SAFT16kHz16BitStereo', 'ISpeechVoiceStatus', 'SP_VISEME_7',
    ...
    'SpInprocRecognizer', 'DISPID_SGRName',
    'SpeechRecoProfileProperties', 'DISPID_SRGCmdSetRuleState',
    'SPSVerb', 'SSTTDictation', 'SVP_14', 'SECHighConfidence',
    'SAFT8kHz16BitMono', 'SAFT8kHz8BitStereo', 'SGDisplay',
    'SPEI_VOICE_CHANGE', 'DISPID_SPRuleName', 'DISPIDSPTSI',
    'ISpeechLexiconWord', 'SREPhraseStart', 'DISPID_SGRsCount'
]
